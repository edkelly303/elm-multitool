// elm-watch hot {"version":"1.1.2","targetName":"elm-multitool demo","webSocketPort":35181}
"use strict";
(() => {
...
${variant}`;
  ...
  var VERSION = "1.1.2";
  var TARGET_NAME = "elm-multitool demo";
  var INITIAL_ELM_COMPILED_TIMESTAMP = Number(
    "1681050482222"
  );
  var ORIGINAL_COMPILATION_MODE = "standard";
  var ORIGINAL_BROWSER_UI_POSITION = "BottomLeft";
  var WEBSOCKET_PORT = "35181";
...
var $author$project$Example$FormSubmitted = {$: 'FormSubmitted'};
var $author$project$Example$FormUpdated = function (a) {
	return {$: 'FormUpdated', a: a};
};
var $edkelly303$elm_any_type_forms$Control$Control = function (a) {
	return {$: 'Control', a: a};
};
var $edkelly303$elm_any_type_forms$Control$State = F2(
	function (a, b) {
...
var $edkelly303$elm_any_type_forms$Control$button = F2(
	function (msg, text) {
		return A2(
...
var $edkelly303$elm_any_type_forms$Control$Debouncing = {$: 'Debouncing'};
var $edkelly303$elm_any_type_forms$Control$Idle = function (a) {
	return {$: 'Idle', a: a};
};
var $edkelly303$elm_any_type_forms$Control$Intact = {$: 'Intact'};
var $edkelly303$elm_any_type_forms$Control$getStatus = F4(
	function (parse, collectErrors, flags, state) {
		var internalState = state.a;
		var _v0 = internalState.status;
		switch (_v0.$) {
			case 'Intact_':
				return $edkelly303$elm_any_type_forms$Control$Intact;
			case 'DebouncingSince':
				return $edkelly303$elm_any_type_forms$Control$Debouncing;
			default:
				...
				var flaggedErrors = A2(collectErrors, state, flags);
				return $edkelly303$elm_any_type_forms$Control$Idle(
					A2(
						$elm$core$List$map,
						$elm$core$Result$Err,
...
var $edkelly303$elm_any_type_forms$Control$initWith = F2(
	function (input, _v0) {
		var control = _v0.a;
		var initialiser = function (i) {
		...
		return $edkelly303$elm_any_type_forms$Control$Control(
...
var $edkelly303$elm_any_type_forms$Path$Path = function (a) {
	return {$: 'Path', a: a};
};
var $edkelly303$elm_any_type_forms$Path$root = $edkelly303$elm_any_type_forms$Path$Path(_List_Nil);
var $edkelly303$elm_any_type_forms$Control$toForm = F4(
	function (label, toFormUpdatedMsg, formSubmittedMsg, _v0) {
		var control = _v0.a;
		var _v1 = control($edkelly303$elm_any_type_forms$Path$root);
		var init = _v1.init;
		var update = _v1.update;
		var view = _v1.view;
		var parse = _v1.parse;
		var setAllIdle = _v1.setAllIdle;
		var emitFlags = _v1.emitFlags;
		var collectErrors = _v1.collectErrors;
		var collectDebouncingReceivers = _v1.collectDebouncingReceivers;
		return {
			init: init,
			initWith: function (output) {
				var _v2 = A2(
					$edkelly303$elm_any_type_forms$Control$initWith,
					output,
					$edkelly303$elm_any_type_forms$Control$Control(control));
				var initialisedControl = _v2.a;
				return initialisedControl($edkelly303$elm_any_type_forms$Path$root).init;
			},
			submit: function (state) {
				var validationErrors = A2(
					...
					state,
					emitFlags(state));
				var parsingResult = parse(state);
				return _Utils_Tuple2(
					setAllIdle(state),
					function () {
						var _v3 = _Utils_Tuple2(parsingResult, validationErrors);
						if (_v3.a.$ === 'Ok') {
							if (!_v3.b.b) {
								var output = _v3.a.a;
			...
			update: F2(
				function (msg, state) {
					return A2(
						...
						$elm$core$Platform$Cmd$map(toFormUpdatedMsg),
						A2(update, msg, state));
				}),
			view: function (s) {
				var internalState = s.a;
				var state = s.b;
				var emittedFlags = emitFlags(s);
				var debouncingReceivers = collectDebouncingReceivers(s);
				var flags = A2(
				...
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onSubmit(formSubmittedMsg)
						]),
					_List_fromArray(
						[
							A2(
							...
							view(
								{
									...
									state: state,
									status: A4(
										$edkelly303$elm_any_type_forms$Control$getStatus,
										parse,
										collectErrors,
										flags,
										A2($edkelly303$elm_any_type_forms$Control$State, internalState, state))
								})),
							A2($edkelly303$elm_any_type_forms$Control$button, formSubmittedMsg, 'Submit')
						]));
			}
		};
	});
...
var $author$project$MultiTool$constructMultiTool = F3(
	function (next, ctor, _v0) {
		var builder = _v0.a;
		var restBuilders = _v0.b;
		return A2(
			next,
			ctor(builder),
			restBuilders);
	});
var $author$project$MultiTool$fieldMaker = F6(
	function (next, fieldName, getField, _v0, _v1, _v2) {
		var child = _v0.a;
		var restChilds = _v0.b;
		var builder = _v1.a;
		var restBuilders = _v1.b;
		var field_ = _v2.a;
		var restFields = _v2.b;
		return _Utils_Tuple2(
			A4(field_, fieldName, getField, child, builder),
			A5(next, fieldName, getField, restChilds, restBuilders, restFields));
	});
var $elm$core$Tuple$pair = F2(
	function (a, b) {
		return _Utils_Tuple2(a, b);
	});
var $author$project$MultiTool$recordEnder = F3(
	function (next, _v0, _v1) {
		...
		return _Utils_Tuple2(
			end_(builder),
			A2(next, restBuilders, restEnds));
	});
var $author$project$MultiTool$recordMaker = F3(
	function (next, recordConstructor, _v0) {
		var record_ = _v0.a;
		var records = _v0.b;
		return _Utils_Tuple2(
			record_(recordConstructor),
			A2(next, recordConstructor, records));
	});
var $author$project$MultiTool$add = F2(
	function (tool, builder) {
		return {
			bool: A2(
				$elm$core$Basics$composeL,
				builder.bool,
				$elm$core$Tuple$pair(tool.bool)),
			constructMultiTool: A2($elm$core$Basics$composeR, builder.constructMultiTool, $author$project$MultiTool$constructMultiTool),
			constructor: builder.constructor,
			end: A2(
				$elm$core$Basics$composeL,
				builder.end,
				$elm$core$Tuple$pair(tool.end)),
			field: A2(
				$elm$core$Basics$composeL,
				builder.field,
				$elm$core$Tuple$pair(tool.field)),
			fieldMaker: A2($elm$core$Basics$composeR, builder.fieldMaker, $author$project$MultiTool$fieldMaker),
			_int: A2(
				$elm$core$Basics$composeL,
				builder._int,
				$elm$core$Tuple$pair(tool._int)),
			record: A2(
				$elm$core$Basics$composeL,
				builder.record,
				$elm$core$Tuple$pair(tool.record)),
			recordEnder: A2($elm$core$Basics$composeR, builder.recordEnder, $author$project$MultiTool$recordEnder),
			recordMaker: A2($elm$core$Basics$composeR, builder.recordMaker, $author$project$MultiTool$recordMaker),
			string: A2(
				$elm$core$Basics$composeL,
				builder.string,
				$elm$core$Tuple$pair(tool.string))
		};
	});
var $author$project$MultiTool$define = function (constructor) {
	return {bool: $elm$core$Basics$identity, constructMultiTool: $elm$core$Basics$identity, constructor: constructor, end: $elm$core$Basics$identity, field: $elm$core$Basics$identity, fieldMaker: $elm$core$Basics$identity, _int: $elm$core$Basics$identity, record: $elm$core$Basics$identity, recordEnder: $elm$core$Basics$identity, recordMaker: $elm$core$Basics$identity, string: $elm$core$Basics$identity};
};
var $author$project$MultiTool$End = {$: 'End'};
var $author$project$MultiTool$doConstructMultiTool = F3(
	function (constructMultiTool_, ctor, builder) {
		return A3(
			constructMultiTool_,
			F2(
				function (output, _v0) {
...
var $author$project$MultiTool$doEndRecord = F3(
	function (recordEnder_, builder, ends) {
		return A3(
			recordEnder_,
			F2(
				function (_v0, _v1) {
					return $author$project$MultiTool$End;
				}),
			builder,
			ends);
	});
var $author$project$MultiTool$doMakeFields = F6(
	function (mapper, fieldName, getField, child, bldr, fields) {
		return A6(
			mapper,
			F5(
...
var $author$project$MultiTool$doMakeRecord = F3(
	function (recordMaker_, recordConstructor, records) {
		return A3(
			recordMaker_,
			F2(
				function (_v0, _v1) {
...
var $author$project$MultiTool$end = function (toolBuilder) {
	var strings = toolBuilder.string($author$project$MultiTool$End);
	var records = toolBuilder.record($author$project$MultiTool$End);
	var ints = toolBuilder._int($author$project$MultiTool$End);
	var fields = toolBuilder.field($author$project$MultiTool$End);
	var ends = toolBuilder.end($author$project$MultiTool$End);
	var bools = toolBuilder.bool($author$project$MultiTool$End);
	return {
		bool: bools,
		build: function (typeBuilder) {
			return A3($author$project$MultiTool$doConstructMultiTool, toolBuilder.constructMultiTool, toolBuilder.constructor, typeBuilder);
		},
		end: function (recordBuilder) {
			return A3($author$project$MultiTool$doEndRecord, toolBuilder.recordEnder, recordBuilder, ends);
		},
		field: F4(
			function (fieldName, getField, child, recordBuilder) {
				return A6($author$project$MultiTool$doMakeFields, toolBuilder.fieldMaker, fieldName, getField, child, recordBuilder, fields);
			}),
		_int: ints,
		record: function (recordConstructor) {
			return A3($author$project$MultiTool$doMakeRecord, toolBuilder.recordMaker, recordConstructor, records);
		},
		string: strings
	};
};
...
var $author$project$Tools$Codec$interface = {bool: $miniBill$elm_codec$Codec$bool, end: $miniBill$elm_codec$Codec$buildObject, field: $miniBill$elm_codec$Codec$field, _int: $miniBill$elm_codec$Codec$int, record: $miniBill$elm_codec$Codec$object, string: $miniBill$elm_codec$Codec$string};
var $edkelly303$elm_any_type_forms$Control$ChangeState = function (a) {
	return {$: 'ChangeState', a: a};
};
var $edkelly303$elm_any_type_forms$Control$Idle_ = {$: 'Idle_'};
var $edkelly303$elm_any_type_forms$Control$Intact_ = {$: 'Intact_'};
var $edkelly303$elm_any_type_forms$Control$Skip = {$: 'Skip'};
...
var $edkelly303$elm_any_type_forms$Path$toString = function (_v0) {
	var path = _v0.a;
	return A2(
		$elm$core$String$join,
		' > ',
...
var $edkelly303$elm_any_type_forms$Control$CheckDebouncer = function (a) {
	return {$: 'CheckDebouncer', a: a};
};
var $edkelly303$elm_any_type_forms$Control$DebouncingSince = function (a) {
	return {$: 'DebouncingSince', a: a};
};
var $edkelly303$elm_any_type_forms$Control$StartDebouncing = function (a) {
...
var $edkelly303$elm_any_type_forms$Control$wrapUpdate = F4(
		...
		switch (wrappedDelta.$) {
			...
			case 'ChangeState':
				...
				return (debounce_ > 0) ? _Utils_Tuple2(
					A2($edkelly303$elm_any_type_forms$Control$State, internalState, newState),
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								A2($elm$core$Task$perform, $edkelly303$elm_any_type_forms$Control$StartDebouncing, $elm$time$Time$now),
								A2($elm$core$Platform$Cmd$map, $edkelly303$elm_any_type_forms$Control$ChangeState, cmd)
							]))) : _Utils_Tuple2(
					A2(
						$edkelly303$elm_any_type_forms$Control$State,
						_Utils_update(
							internalState,
							{status: $edkelly303$elm_any_type_forms$Control$Idle_}),
						newState),
					A2($elm$core$Platform$Cmd$map, $edkelly303$elm_any_type_forms$Control$ChangeState, cmd));
				...
				return _Utils_Tuple2(
					A2(
						...
						_Utils_update(
							internalState,
							{
								status: $edkelly303$elm_any_type_forms$Control$DebouncingSince(now)
							}),
						state),
					A2(
						$elm$core$Task$perform,
						function (_v3) {
							return $edkelly303$elm_any_type_forms$Control$CheckDebouncer(now);
						},
						$elm$core$Process$sleep(debounce_)));
			case 'CheckDebouncer':
				var now = wrappedDelta.a;
				var _v4 = internalState.status;
				if (_v4.$ === 'DebouncingSince') {
					var startTime = _v4.a;
...
var $edkelly303$elm_any_type_forms$Control$wrappedView = F2(
...
var $edkelly303$elm_any_type_forms$Control$create = function (config) {
	return $edkelly303$elm_any_type_forms$Control$Control(
		function (path) {
			var preUpdate = $edkelly303$elm_any_type_forms$Control$wrapUpdate(
				F2(
					function (delta, state) {
						return _Utils_Tuple2(
							A2(config.update, delta, state),
							$elm$core$Platform$Cmd$none);
					}));
			var parse = function (_v7) {
				...
				return A2(
					...
					$elm$core$List$map(
						$elm$core$Tuple$pair(
							$edkelly303$elm_any_type_forms$Path$toString(path))),
					config.parse(state));
			};
			return {
				baseUpdate: preUpdate,
				childViews: function (_v0) {
					return _List_Nil;
				},
				...
				delta: $edkelly303$elm_any_type_forms$Control$Skip,
				emitFlags: function (_v4) {
					return _List_Nil;
				},
				index: 0,
				init: A2(
					$edkelly303$elm_any_type_forms$Control$State,
					{selected: 0, status: $edkelly303$elm_any_type_forms$Control$Intact_},
					config.initEmpty),
				...
				parse: parse,
				path: path,
				receiverCount: _List_Nil,
				setAllIdle: function (_v5) {
					var i = _v5.a;
					var s = _v5.b;
					return A2(
						$edkelly303$elm_any_type_forms$Control$State,
				...
				view: function (_v6) {
					var state = _v6.state;
					var status = _v6.status;
					return A2(
						$elm$html$Html$map,
						$edkelly303$elm_any_type_forms$Control$ChangeState,
						A2(
							$edkelly303$elm_any_type_forms$Control$wrappedView,
							status,
							config.view(state)));
				}
			};
...
var $edkelly303$elm_any_type_forms$Control$onChecked = function (msg) {
	return A2(
		$elm$html$Html$Events$on,
		'input',
		A2(
...
var $edkelly303$elm_any_type_forms$Control$radioView = function (_v0) {
	var options = _v0.options;
	var selectedOption = _v0.selectedOption;
	var toMsg = _v0.toMsg;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$core$String$repeat, columns, '1fr '))
			]),
		A2(
			$elm$core$List$map,
			function (_v1) {
				var option = _v1.a;
				var optionLabel = _v1.b;
				return A2(
					$elm$html$Html$div,
					_List_Nil,
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									...
									_Utils_eq(selectedOption, option)),
									$edkelly303$elm_any_type_forms$Control$onChecked(
									toMsg(option))
								]),
							_List_Nil),
							A2(
...
var $edkelly303$elm_any_type_forms$Control$enumView = F2(
	function (tags, config) {
		return $edkelly303$elm_any_type_forms$Control$radioView(
			{
				columns: 3,
				options: A2(
					$elm$core$List$map,
				...
				toMsg: $elm$core$Basics$identity
			});
	});
...
var $edkelly303$elm_any_type_forms$Control$enum = F3(
	function (first, second, rest) {
		return $edkelly303$elm_any_type_forms$Control$create(
			{
				initEmpty: first.b,
				initWith: $elm$core$Basics$identity,
				parse: $elm$core$Result$Ok,
				update: F2(
					function (delta, _v0) {
						return delta;
					}),
				view: $edkelly303$elm_any_type_forms$Control$enumView(
					A2(
						$elm$core$List$cons,
						first,
...
var $edkelly303$elm_any_type_forms$Control$bool = F2(
	function (trueId, falseId) {
		return A3(
			$edkelly303$elm_any_type_forms$Control$enum,
			_Utils_Tuple2(trueId, true),
			_Utils_Tuple2(falseId, false),
			_List_Nil);
	});
var $edkelly303$elm_any_type_forms$Control$End = {$: 'End'};
var $edkelly303$elm_any_type_forms$Control$applyStateSettersToInitialiser = F4(
...
var $edkelly303$elm_any_type_forms$Control$collectDebouncingReceiversForCustomType = F3(
...
var $edkelly303$elm_any_type_forms$Control$collectErrorsForCustomType = F4(
	function (errorCollector_, flags, fns, states) {
		return A5(
			errorCollector_,
			F4(
...
var $edkelly303$elm_any_type_forms$Control$TagSelected = function (a) {
	return {$: 'TagSelected', a: a};
};
var $edkelly303$elm_any_type_forms$Control$customTypeView = F3(
	function (options, selectedTag, selectedTagView) {
		return A2(
			$elm$html$Html$div,
			_List_Nil,
			($elm$core$List$length(options) > 1) ? _List_fromArray(
				[
					$edkelly303$elm_any_type_forms$Control$radioView(
					{columns: 3, options: options, selectedOption: selectedTag, toMsg: $edkelly303$elm_any_type_forms$Control$TagSelected}),
					A2($elm$html$Html$div, _List_Nil, selectedTagView)
				]) : selectedTagView);
	});
var $edkelly303$elm_any_type_forms$Control$emitFlagsForCustomType = F4(
	function (flagEmitter_, selectedTag, fns, tagStates) {
		return A5(
			flagEmitter_,
			F4(
				function (flags, _v0, _v1, _v2) {
					return flags;
				}),
			_List_Nil,
			selectedTag,
...
var $edkelly303$elm_any_type_forms$Control$makeDeltaSetters = F3(
	function (makeSetters_, befores, afters) {
		return A3(
			makeSetters_,
			F2(
				function (_v0, _v1) {
					return $edkelly303$elm_any_type_forms$Control$End;
				}),
			befores($edkelly303$elm_any_type_forms$Control$End),
			afters);
	});
var $edkelly303$elm_any_type_forms$Control$makeStateSetters = F7(
	function (makeSetters_, argStateIntoTagStateInserter_, inits, fns, toArgStates, befores, afters) {
		return A7(
			...
			inits,
			fns,
			toArgStates($edkelly303$elm_any_type_forms$Control$End),
			befores($edkelly303$elm_any_type_forms$Control$End),
			afters);
	});
var $edkelly303$elm_any_type_forms$Control$setSelectedTagStateIdle = F4(
...
var $edkelly303$elm_any_type_forms$Control$updateCustomTypeStates = F5(
	function (updater, fields, setters, deltas, states) {
		...
		return _Utils_Tuple2(
			newStates($edkelly303$elm_any_type_forms$Control$End),
			$elm$core$Platform$Cmd$batch(newCmds));
	});
var $edkelly303$elm_any_type_forms$Control$validateSelectedTagState = F4(
	function (parser, selectedTag, fns, states) {
		return A5(
			parser,
			F4(
				function (result, _v0, _v1, _v2) {
					return result;
				}),
			$elm$core$Result$Err(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'FATAL ERROR',
						'tag index ' + ($elm$core$String$fromInt(selectedTag) + ' not found'))
					])),
			selectedTag,
			fns,
			states);
...
var $edkelly303$elm_any_type_forms$Control$viewSelectedTagState = F6(
	function (viewer, flags, selectedTag, fns, setters, states) {
		return A2(
			$elm$core$Maybe$withDefault,
			$elm$html$Html$text('ERROR!'),
			A2(
				$elm$core$Maybe$map,
				$elm$html$Html$map($edkelly303$elm_any_type_forms$Control$ChangeState),
				A7(
					viewer,
					F6(
						function (maybeView, _v0, _v1, _v2, _v3, _v4) {
							return maybeView;
						}),
					$elm$core$Maybe$Nothing,
					flags,
...
var $edkelly303$elm_any_type_forms$Control$endCustomType = function (rec) {
	return $edkelly303$elm_any_type_forms$Control$Control(
		function (path) {
			var labels = $elm$core$List$reverse(rec.labels);
			var inits = A2(rec.states, path, $edkelly303$elm_any_type_forms$Control$End);
			var fns = A2(rec.fns, path, $edkelly303$elm_any_type_forms$Control$End);
			var parse = function (_v8) {
				var i = _v8.a;
				var state = _v8.b;
				return A4($edkelly303$elm_any_type_forms$Control$validateSelectedTagState, rec.parser, i.selected, fns, state);
			};
			var setAllIdle = function (_v7) {
				var i = _v7.a;
				var state = _v7.b;
				return A2(
					$edkelly303$elm_any_type_forms$Control$State,
					_Utils_update(
						i,
						{status: $edkelly303$elm_any_type_forms$Control$Idle_}),
					A4($edkelly303$elm_any_type_forms$Control$setSelectedTagStateIdle, rec.idleSetter, i.selected, fns, state));
			};
			var stateSetters = A7($edkelly303$elm_any_type_forms$Control$makeStateSetters, rec.makeStateSetters, rec.stateInserter, inits, fns, rec.toArgStates, rec.stateBefores, rec.stateAfters);
			var emitFlags = function (_v6) {
				var i = _v6.a;
				var state = _v6.b;
				return A4($edkelly303$elm_any_type_forms$Control$emitFlagsForCustomType, rec.flagEmitter, i.selected, fns, state);
			};
			var deltaSetters = A3($edkelly303$elm_any_type_forms$Control$makeDeltaSetters, rec.makeDeltaSetters, rec.deltaBefores, rec.deltaAfters);
			var update = F2(
				function (delta, _v3) {
					var i = _v3.a;
					var state = _v3.b;
					switch (delta.$) {
						case 'Skip':
							return _Utils_Tuple2(
								A2($edkelly303$elm_any_type_forms$Control$State, i, state),
								$elm$core$Platform$Cmd$none);
						case 'TagSelected':
							var idx = delta.a;
							return _Utils_Tuple2(
						...
						case 'ChangeState':
							...
							var _v5 = A5($edkelly303$elm_any_type_forms$Control$updateCustomTypeStates, rec.updater, fns, deltaSetters, tagDelta, state);
							var newTagStates = _v5.a;
							var cmd = _v5.b;
							return _Utils_Tuple2(
								A2($edkelly303$elm_any_type_forms$Control$State, i, newTagStates),
								A2($elm$core$Platform$Cmd$map, $edkelly303$elm_any_type_forms$Control$ChangeState, cmd));
						default:
							return _Utils_Tuple2(
								A2($edkelly303$elm_any_type_forms$Control$State, i, state),
			...
			var childViews = function (config) {
				return _List_fromArray(
					[
						A6($edkelly303$elm_any_type_forms$Control$viewSelectedTagState, rec.viewer, config.flags, config.selected, fns, deltaSetters, config.state)
					]);
			};
			var view = function (config) {
				var options = A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, labels);
				var childViews_ = childViews(config);
				return A3($edkelly303$elm_any_type_forms$Control$customTypeView, options, config.selected, childViews_);
			};
			return {
				...
				collectDebouncingReceivers: function (_v1) {
					var states = _v1.b;
					return A3($edkelly303$elm_any_type_forms$Control$collectDebouncingReceiversForCustomType, rec.debouncingReceiverCollector, fns, states);
				},
				collectErrors: F2(
					function (_v2, flags) {
						var states = _v2.b;
						return A4($edkelly303$elm_any_type_forms$Control$collectErrorsForCustomType, rec.errorCollector, flags, fns, states);
					}),
				delta: $edkelly303$elm_any_type_forms$Control$Skip,
				emitFlags: emitFlags,
				index: 0,
				init: A2(
					...
					{selected: 0, status: $edkelly303$elm_any_type_forms$Control$Intact_},
					inits),
				initWith: A3($edkelly303$elm_any_type_forms$Control$applyStateSettersToInitialiser, rec.applyInputs, rec.destructor, stateSetters),
				parse: parse,
				path: path,
				receiverCount: _List_Nil,
...
var $edkelly303$elm_any_type_forms$Control$collectDebouncingReceiversForRecord = F3(
	function (debouncingReceiverCollector_, fns, states) {
		return A4(
			debouncingReceiverCollector_,
			F3(
...
var $edkelly303$elm_any_type_forms$Control$collectErrorsForRecord = F4(
	function (errorCollector_, flags, fns, states) {
		return A5(
			errorCollector_,
			F4(
...
var $edkelly303$elm_any_type_forms$Control$emitFlagsForRecord = F3(
	function (flagEmitter_, fns, states) {
		return A4(
			flagEmitter_,
			F3(
...
var $edkelly303$elm_any_type_forms$Control$initialiseRecordStates = F3(
...
var $edkelly303$elm_any_type_forms$Control$setAllRecordStatesToIdle = F3(
...
var $edkelly303$elm_any_type_forms$Control$updateRecordStates = F5(
	function (updater, fields, setters, deltas, states) {
		var _v0 = A6(
			updater,
			F5(
...
var $edkelly303$elm_any_type_forms$Control$validateRecordStates = F4(
...
var $edkelly303$elm_any_type_forms$Control$viewRecordStates = F5(
	function (viewer, flags, fns, setters, states) {
...
var $edkelly303$elm_any_type_forms$Control$endRecord = function (rec) {
	return $edkelly303$elm_any_type_forms$Control$Control(
		function (path) {
			var view = F2(
				function (childViews_, config) {
					var labelViews = A2(
						$elm$core$List$map,
						function (label) {
							return A2(
						...
						rec.labels);
					var fieldViews = childViews_(config);
					var combinedViews = A3(
						$elm$core$List$map2,
						F2(
							function (labelView, fieldView) {
								return _Utils_eq(
									fieldView,
									$elm$html$Html$text('')) ? $elm$html$Html$text('') : A2(
									$elm$html$Html$li,
									_List_Nil,
									_List_fromArray(
										[labelView, fieldView]));
						...
						labelViews,
						fieldViews);
					return ($elm$core$List$length(combinedViews) > 1) ? A2($elm$html$Html$ul, _List_Nil, combinedViews) : A2($elm$html$Html$div, _List_Nil, fieldViews);
				});
			var inits = A2(rec.states, path, $edkelly303$elm_any_type_forms$Control$End);
			var fns = A2(rec.fields, path, $edkelly303$elm_any_type_forms$Control$End);
			var parse = function (_v8) {
				var state = _v8.b;
				return A4($edkelly303$elm_any_type_forms$Control$validateRecordStates, rec.parser, rec.toOutput, fns, state);
			};
			var setAllIdle = function (_v7) {
				var i = _v7.a;
				var state = _v7.b;
				return A2(
					...
					_Utils_update(
						i,
						{status: $edkelly303$elm_any_type_forms$Control$Idle_}),
					A3($edkelly303$elm_any_type_forms$Control$setAllRecordStatesToIdle, rec.idleSetter, fns, state));
			};
			var emitFlags = function (_v6) {
				var state = _v6.b;
				return A3($edkelly303$elm_any_type_forms$Control$emitFlagsForRecord, rec.flagEmitter, fns, state);
			};
			var deltaSetters = A3($edkelly303$elm_any_type_forms$Control$makeDeltaSetters, rec.makeSetters, rec.befores, rec.afters);
			var update = F2(
				function (delta, _v5) {
					var s = _v5.a;
					var state = _v5.b;
					switch (delta.$) {
						case 'Skip':
							return _Utils_Tuple2(
								A2($edkelly303$elm_any_type_forms$Control$State, s, state),
								$elm$core$Platform$Cmd$none);
						case 'ChangeState':
							var deltas = delta.a;
							var _v4 = A5($edkelly303$elm_any_type_forms$Control$updateRecordStates, rec.updater, fns, deltaSetters, deltas, state);
							var newState = _v4.a;
							var cmd = _v4.b;
							return _Utils_Tuple2(
								A2($edkelly303$elm_any_type_forms$Control$State, s, newState),
								A2($elm$core$Platform$Cmd$map, $edkelly303$elm_any_type_forms$Control$ChangeState, cmd));
						default:
							return _Utils_Tuple2(
								A2($edkelly303$elm_any_type_forms$Control$State, s, state),
			...
			var childViews = function (config) {
				return A5($edkelly303$elm_any_type_forms$Control$viewRecordStates, rec.viewer, config.flags, fns, deltaSetters, config.state);
			};
			return {
				baseUpdate: function (_v0) {
					return update;
				},
				childViews: function (config) {
					return childViews(config);
				},
				collectDebouncingReceivers: function (_v1) {
					var states = _v1.b;
					return A3($edkelly303$elm_any_type_forms$Control$collectDebouncingReceiversForRecord, rec.debouncingReceiverCollector, fns, states);
				},
				collectErrors: F2(
					function (_v2, flags) {
						var states = _v2.b;
						return A4($edkelly303$elm_any_type_forms$Control$collectErrorsForRecord, rec.errorCollector, flags, fns, states);
					}),
				delta: $edkelly303$elm_any_type_forms$Control$Skip,
				emitFlags: emitFlags,
				index: 0,
				init: A2(
					...
					inits),
				initWith: function (output) {
					return A3($edkelly303$elm_any_type_forms$Control$initialiseRecordStates, rec.initialiser, output, fns);
				},
				parse: parse,
				path: path,
				receiverCount: _List_Nil,
				...
				update: update,
				view: function (config) {
					return A2(view, childViews, config);
				}
			};
		});
};
var $edkelly303$elm_any_type_forms$Control$end = function (builder) {
	if (builder.$ === 'Rec') {
		var r = builder.a;
		return $edkelly303$elm_any_type_forms$Control$endRecord(r);
	} else {
		var c = builder.a;
		return $edkelly303$elm_any_type_forms$Control$endCustomType(c);
	}
};
var $edkelly303$elm_any_type_forms$Control$Open = {$: 'Open'};
var $edkelly303$elm_any_type_forms$Control$Cus = function (a) {
	return {$: 'Cus', a: a};
};
var $edkelly303$elm_any_type_forms$Control$Rec = function (a) {
	return {$: 'Rec', a: a};
};
var $edkelly303$elm_any_type_forms$Path$add = F2(
	function (segment, _v0) {
		var path = _v0.a;
		return $edkelly303$elm_any_type_forms$Path$Path(
			A2($elm$core$List$cons, segment, path));
	});
var $edkelly303$elm_any_type_forms$Control$deltaSetterMaker = F3(
	function (next, _v0, _v1) {
		var before = _v0.a;
		var befores = _v0.b;
		var after = _v1.a;
...
var $edkelly303$elm_any_type_forms$Control$recordDebouncingReceiverCollector = F4(
	function (next, receivers, _v0, _v1) {
		...
		return A3(
			...
			_Utils_ap(
				receivers,
				fns.field.collectDebouncingReceivers(state)),
			restFns,
			restStates);
	});
var $edkelly303$elm_any_type_forms$Control$recordErrorCollector = F5(
	function (next, flags, errors, _v0, _v1) {
		var fns = _v0.a;
		var restFns = _v0.b;
		var state = _v1.a;
		var restStates = _v1.b;
		return A4(
			...
			_Utils_ap(
				errors,
				A2(fns.field.collectErrors, state, flags)),
			restFns,
			restStates);
	});
var $edkelly303$elm_any_type_forms$Control$recordFlagEmitter = F4(
	function (next, flags, _v0, _v1) {
		var fns = _v0.a;
		var restFns = _v0.b;
		var state = _v1.a;
		var restStates = _v1.b;
		var newFlags = fns.field.emitFlags(state);
		return A3(
			next,
			_Utils_ap(flags, newFlags),
			restFns,
			restStates);
	});
var $edkelly303$elm_any_type_forms$Control$recordStateIdleSetter = F3(
	function (next, _v0, _v1) {
		var fns = _v0.a;
		var restFns = _v0.b;
		var state = _v1.a;
...
var $edkelly303$elm_any_type_forms$Control$recordStateInitialiser = F3(
...
var $edkelly303$elm_any_type_forms$Control$recordStateUpdater = F6(
	function (next, _v0, _v1, _v2, _v3, _v4) {
		...
		var _v5 = A2(fns.field.update, delta, state);
		var newState = _v5.a;
		var newCmd = _v5.b;
...
var $edkelly303$elm_any_type_forms$Control$recordStateValidator = F4(
...
var $edkelly303$elm_any_type_forms$Control$recordStateViewer = F6(
	function (next, views, flags, _v0, _v1, _v2) {
		var fns = _v0.a;
		var restFns = _v0.b;
		var setter = _v1.a;
		...
		var view = A2(
			$elm$html$Html$map,
			function (delta) {
				return $edkelly303$elm_any_type_forms$Control$ChangeState(
					setter(delta));
			},
			fns.field.view(
				{
...
var $edkelly303$elm_any_type_forms$Control$fieldHelper = F5(
	function (access, label, fromInput, _v0, builder) {
		var control = _v0.a;
		if (builder.$ === 'Cus') {
			var c = builder.a;
			return $edkelly303$elm_any_type_forms$Control$Cus(c);
		} else {
			var rec = builder.a;
			return $edkelly303$elm_any_type_forms$Control$Rec(
				{
					after: _Utils_Tuple2($edkelly303$elm_any_type_forms$Control$Skip, rec.after),
					afters: _Utils_Tuple2(rec.after, rec.afters),
					before: A2(
						$elm$core$Basics$composeL,
						rec.before,
						$elm$core$Tuple$pair($edkelly303$elm_any_type_forms$Control$Skip)),
					befores: A2(
						$elm$core$Basics$composeL,
						rec.befores,
						$elm$core$Tuple$pair(rec.before)),
					debouncingReceiverCollector: A2($elm$core$Basics$composeR, rec.debouncingReceiverCollector, $edkelly303$elm_any_type_forms$Control$recordDebouncingReceiverCollector),
					errorCollector: A2($elm$core$Basics$composeR, rec.errorCollector, $edkelly303$elm_any_type_forms$Control$recordErrorCollector),
							...
							$elm$core$Tuple$pair(
								{
									access: access,
									field: control(
										A2($edkelly303$elm_any_type_forms$Path$add, label, path)),
									fromInput: fromInput
								}));
					},
					flagEmitter: A2($elm$core$Basics$composeR, rec.flagEmitter, $edkelly303$elm_any_type_forms$Control$recordFlagEmitter),
					idleSetter: A2($elm$core$Basics$composeR, rec.idleSetter, $edkelly303$elm_any_type_forms$Control$recordStateIdleSetter),
					index: rec.index + 1,
					initialiser: A2($elm$core$Basics$composeR, rec.initialiser, $edkelly303$elm_any_type_forms$Control$recordStateInitialiser),
					labels: _Utils_ap(
						rec.labels,
						_List_fromArray(
							[label])),
					makeSetters: A2($elm$core$Basics$composeR, rec.makeSetters, $edkelly303$elm_any_type_forms$Control$deltaSetterMaker),
					parser: A2($elm$core$Basics$composeR, rec.parser, $edkelly303$elm_any_type_forms$Control$recordStateValidator),
					states: function (path) {
						return A2(
							$elm$core$Basics$composeL,
							rec.states(path),
							$elm$core$Tuple$pair(
								control(
									A2($edkelly303$elm_any_type_forms$Path$add, label, path)).init));
					},
					toOutput: rec.toOutput,
					updater: A2($elm$core$Basics$composeR, rec.updater, $edkelly303$elm_any_type_forms$Control$recordStateUpdater),
					viewer: A2($elm$core$Basics$composeR, rec.viewer, $edkelly303$elm_any_type_forms$Control$recordStateViewer)
				});
		}
	});
var $edkelly303$elm_any_type_forms$Control$field = $edkelly303$elm_any_type_forms$Control$fieldHelper($edkelly303$elm_any_type_forms$Control$Open);
var $edkelly303$elm_any_type_forms$Control$debounce = F2(
	function (millis, _v0) {
		var control = _v0.a;
		var debouncer = function (i) {
			return _Utils_update(
				i,
				{
					update: i.baseUpdate(millis)
				});
		};
		return $edkelly303$elm_any_type_forms$Control$Control(
...
var $edkelly303$elm_any_type_forms$Control$textControlView = F2(
	function (type_, state) {
		return A2(
			$elm$html$Html$input,
			_List_fromArray(
				[
...
var $edkelly303$elm_any_type_forms$Control$int = A2(
	$edkelly303$elm_any_type_forms$Control$debounce,
	500,
	$edkelly303$elm_any_type_forms$Control$create(
		{
			initEmpty: '',
			initWith: $elm$core$String$fromInt,
			...
			view: $edkelly303$elm_any_type_forms$Control$textControlView('number')
		}));
var $edkelly303$elm_any_type_forms$Control$record = function (toOutput) {
	return $edkelly303$elm_any_type_forms$Control$Rec(
		{
			after: $edkelly303$elm_any_type_forms$Control$End,
			afters: $edkelly303$elm_any_type_forms$Control$End,
			...
			flagEmitter: $elm$core$Basics$identity,
...
var $edkelly303$elm_any_type_forms$Control$string = A2(
	$edkelly303$elm_any_type_forms$Control$debounce,
	500,
	$edkelly303$elm_any_type_forms$Control$create(
		{
			...
			view: $edkelly303$elm_any_type_forms$Control$textControlView('text')
		}));
var $author$project$Tools$Control$interface = {
	bool: A2($edkelly303$elm_any_type_forms$Control$bool, 'yes', 'no'),
	end: $edkelly303$elm_any_type_forms$Control$end,
	field: $edkelly303$elm_any_type_forms$Control$field,
	_int: $edkelly303$elm_any_type_forms$Control$int,
	record: $edkelly303$elm_any_type_forms$Control$record,
	string: $edkelly303$elm_any_type_forms$Control$string
};
var $author$project$Tools$ToComparable$compBool = function (b) {
	return b ? 1 : 0;
};
var $author$project$Tools$ToComparable$compEnd = function (builder) {
	return function (rest) {
		return A2(builder, 0, rest);
	};
};
var $author$project$Tools$ToComparable$compField = F4(
	function (fieldName, getField, toComparable, builder) {
		return F2(
			function (rest, recordData) {
				var _this = toComparable(
					getField(recordData));
				return A2(
					builder,
					_Utils_Tuple2(_this, rest),
					recordData);
			});
	});
var $author$project$Tools$ToComparable$compInt = $elm$core$Basics$identity;
var $author$project$Tools$ToComparable$compRecord = function (ctor) {
	return F2(
		function (rest, _v0) {
			return rest;
		});
...
var $author$project$Tools$ToComparable$compString = $elm$core$String$toLower;
var $author$project$Tools$ToComparable$interface = {bool: $author$project$Tools$ToComparable$compBool, end: $author$project$Tools$ToComparable$compEnd, field: $author$project$Tools$ToComparable$compField, _int: $author$project$Tools$ToComparable$compInt, record: $author$project$Tools$ToComparable$compRecord, string: $author$project$Tools$ToComparable$compString};
var $author$project$Tools$ToString$strBool = function (b) {
	return b ? 'True' : 'False';
};
var $author$project$Tools$ToString$strEnd = function (builder) {
...
var $author$project$Tools$ToString$strField = F4(
	function (fieldName, getField, toString, builder) {
		return function (recordData) {
			return A2(
				$elm$core$List$cons,
				fieldName + (' = ' + toString(
...
var $author$project$Tools$ToString$strInt = $elm$core$String$fromInt;
var $author$project$Tools$ToString$strRecord = function (ctor) {
	return function (recordData) {
		return _List_Nil;
	};
};
var $author$project$Tools$ToString$strString = $elm$core$Basics$identity;
var $author$project$Tools$ToString$interface = {bool: $author$project$Tools$ToString$strBool, end: $author$project$Tools$ToString$strEnd, field: $author$project$Tools$ToString$strField, _int: $author$project$Tools$ToString$strInt, record: $author$project$Tools$ToString$strRecord, string: $author$project$Tools$ToString$strString};
var $author$project$Example$multiTool = $author$project$MultiTool$end(
	A2(
		$author$project$MultiTool$add,
		$author$project$Tools$ToComparable$interface,
		A2(
			$author$project$MultiTool$add,
			$author$project$Tools$Control$interface,
			A2(
				$author$project$MultiTool$add,
				$author$project$Tools$Codec$interface,
				A2(
					$author$project$MultiTool$add,
					$author$project$Tools$ToString$interface,
					$author$project$MultiTool$define(
						F4(
							function (toString, codec, control, toComparable) {
								return {codec: codec, control: control, toComparable: toComparable, toString: toString};
							})))))));
var $author$project$Example$User = F3(
	function (name, age, hobbies) {
		return {age: age, hobbies: hobbies, name: name};
	});
var $author$project$Example$Hobbies = F2(
	function (skis, surfs) {
		return {skis: skis, surfs: surfs};
	});
var $author$project$Example$hobbies = $author$project$Example$multiTool.end(
	A4(
		$author$project$Example$multiTool.field,
		'skis',
		function ($) {
			return $.skis;
		},
		$author$project$Example$multiTool.bool,
		A4(
			$author$project$Example$multiTool.field,
			'surfs',
			function ($) {
			...
			$author$project$Example$multiTool.bool,
			$author$project$Example$multiTool.record($author$project$Example$Hobbies))));
var $author$project$Example$user = $author$project$Example$multiTool.end(
	A4(
		$author$project$Example$multiTool.field,
		'hobbies',
		function ($) {
		...
		$author$project$Example$hobbies,
		A4(
			$author$project$Example$multiTool.field,
			'age',
			function ($) {
			...
			$author$project$Example$multiTool._int,
			A4(
				$author$project$Example$multiTool.field,
				'name',
				function ($) {
				...
				$author$project$Example$multiTool.string,
				$author$project$Example$multiTool.record($author$project$Example$User)))));
var $author$project$Example$tools = $author$project$Example$multiTool.build($author$project$Example$user);
var $author$project$Example$form = A4($edkelly303$elm_any_type_forms$Control$toForm, 'User Form', $author$project$Example$FormUpdated, $author$project$Example$FormSubmitted, $author$project$Example$tools.control);
var $author$project$Example$users = _List_fromArray(
	[
		{
		age: 35,
		hobbies: {skis: false, surfs: true},
		name: 'Pete'
	},
		{
		age: 41,
		hobbies: {skis: true, surfs: false},
		name: 'Ed'
	},
		{
		age: 48,
...
var $author$project$Example$init = function (_v0) {
	return _Utils_Tuple2(
		{form: $author$project$Example$form.init, users: $author$project$Example$users},
		$elm$core$Platform$Cmd$none);
};
...
var $author$project$Example$update = F2(
	function (msg, model) {
		if (msg.$ === 'FormUpdated') {
			var delta = msg.a;
			var _v1 = A2($author$project$Example$form.update, delta, model.form);
			var newForm = _v1.a;
			var cmd = _v1.b;
			return _Utils_Tuple2(
				_Utils_update(
			...
			var _v2 = $author$project$Example$form.submit(model.form);
			var newForm = _v2.a;
			var result = _v2.b;
			if (result.$ === 'Ok') {
				var u = result.a;
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							form: newForm,
							users: A2($elm$core$List$cons, u, model.users)
						}),
					$elm$core$Platform$Cmd$none);
			} else {
				return _Utils_Tuple2(
...
var $author$project$Example$viewUsers = function (users_) {
	return $elm$html$Html$text(
		A2(
			$elm$core$String$join,
			'\n',
			A2($elm$core$List$map, $author$project$Example$tools.toString, users_)));
};
var $author$project$Example$view = function (model) {
	var json = A3(
		$miniBill$elm_codec$Codec$encodeToString,
		4,
		$miniBill$elm_codec$Codec$list($author$project$Example$tools.codec),
		model.users);
	return A2(
		$elm$html$Html$pre,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('elm-multitool demo')
					])),
				A2(
				$elm$html$Html$h2,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('control: create a user')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$author$project$Example$form.view(model.form)
					])),
				A2(
				$elm$html$Html$h2,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('toString: stringify users')
					])),
				$author$project$Example$viewUsers(model.users),
				A2(
				$elm$html$Html$h2,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('toComparable: sort users')
					])),
				$author$project$Example$viewUsers(
				A2($elm$core$List$sortBy, $author$project$Example$tools.toComparable, model.users)),
				A2(
				$elm$html$Html$h2,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('codec: encode users as JSON')
					])),
